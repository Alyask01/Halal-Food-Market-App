    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                //Count the Rows to check whether the id is valud or not
...
<h1 class="text-right2"><a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/document/d/159Bul1oUm-va1zVYtjXA1USqhdWMKHV4/edit#bookmark=id.4qs0r7yunh7f" class="float2 btn-primary2 btn2 btn-bigtext">Help</a></h1>
